...
import org.gbif.pipelines.parsers.location.*;
import org.gbif.pipelines.parsers.location.ParsedLocation;
...
public class LocationInterpreter {
  ...
  /** {@link GbifTerm#depth} and {@link GbifTerm#depthAccuracy} interpretation. */
